...
const menu = {
  ...
  containers: menuSpritesheet.containerImageAssets,
  toggles: { 
    menuSection: menuSpritesheet.menuBtnAssets, 
    stanceSection: menuSpritesheet.stanceBtnAssets, 
    mapContentsSection: menuSpritesheet.arrowBtnAssets 
  },
  loaded: false
};
...
//     if (!isInsideScreenBounds(dx, dy) && !itemIsInEquipSection(dx, dy)) {
//       item.isDragging = false;
//       canvas.style.cursor = 'crosshair';
//     }; 
...
//     if (itemIsInEquipSection(dx, dy) && menuToggle === 'inventory') {
